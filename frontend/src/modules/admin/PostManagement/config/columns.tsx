...
import { ActionsCell, StatusCell, DateCell } from '../components/TableCells';
import { ITreeNode } from '../libs/utils';

export const columns: ColumnDef<ITreeNode>[] = [
  {
    id: 'stt',
  ...
  {
    accessorKey: 'name',
    header: () => <CenteredHeader>Tiêu đề / Tác giả</CenteredHeader>,
    cell: ({ row }) => {
